...
function M.CallFSharpWorkspacePeek(directoryPath, depth, excludedDirs, handler)
        ...
        return M.handlers.Call("fsharp/workspacePeek",
                M.CreateFSharpWorkspacePeekRequest(directoryPath, depth, excludedDirs))
end
...
function M.Initialize()
        if not vim.fn.has("nvim") then
                M.util.notify(
                        "WARNING - This version of Ionide is only for NeoVim. please try Ionide/Ionide-Vim instead. ")
                return
        end
